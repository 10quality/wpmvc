...
sidebar_position: 1
title: Skills
description: Explore the official AI coding agent skill for the WordPress MVC (WPMVC) framework.
keywords: [wpmvc ai coding skill, wordpress mvc ai agent skill, wpmvc ai integration, wordpress plugin development ai skill, wordpress theme development ai skill, wpmvc best practices ai skill, wpmvc coding guidelines ai skill]

---

<head>
  <title>AI Coding Skill for WPMVC</title>
</head>
...
* Guidance on [asset management](/resources/assets.md) using Gulp for compilation.
* Use of [Ayuco](/cli/ayuco.md) CLI for scaffolding and namespace management.
